...
module.exports = (deployer, network, accounts) => {
    ...
    deployer.deploy(IMP_Token, TOKEN_NAME, TOKEN_SYMBOL, TOKEN_DECIMALS).then(async () => {
        ...
        await deployer.deploy(IMP_Crowdsale, CROWDSALE_TYPE_PRE_ICO, [CROWDSALE_OPENING, CROWDSALE_CLOSING], CROWDSALE_WALLET, token.address, CROWDSALE_TOTAL_SUPPLY_LIMIT, [TOKEN_PERCENTAGE_RESERVED_PRE_ICO, TOKEN_PERCENTAGE_RESERVED_ICO, TOKEN_PERCENTAGE_RESERVED_TEAM, TOKEN_PERCENTAGE_RESERVED_PLATFORM, TOKEN_PERCENTAGE_RESERVED_AIRDROPS], PRE_ICO_DISCOUNTS);
