...
contract("IMP_Crowdsale_Stage", (accounts) => {
    let token;
    let crowdsale;
    let sharedLedger;
    ...
    describe("validate finalize function", () => {
        it("should validate limits are being recalculated after finalization", async () => {
            ...
            crowdsale = await IMP_Crowdsale_Stage.new(token.address, sharedLedger.address, CROWDSALE_WALLET, mockCrowdsaleData.crowdsaleRateEth, timings, mockCrowdsaleData.crowdsaleICODiscounts);
