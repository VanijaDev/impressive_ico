...
contract IMP_Crowdsale is WhitelistedCrowdsale {
   ...
   */
  constructor(uint256 _rate, uint256 _icoTotalSupplyLimit, uint256 _tokenPercentagePurchaseLimit, address _wallet, IMP_Token _token) Crowdsale(_rate, _wallet, _token) public {
