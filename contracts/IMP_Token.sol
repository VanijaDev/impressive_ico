...
contract IMP_Token is MintableToken, DetailedERC20 {
  ...
  constructor(string _name, string _symbol, uint8 _decimals, uint256 _crowdsaleTotalSupplyLimit, uint8 _preICOTotalSupplyLimitPercent, uint8 _icoTotalSupplyLimitPercent, uint8 _teamSupplyReservedPercent, uint8 _platformSupplyReservedPercent) DetailedERC20(_name, _symbol, _decimals) public {
    ...
    crowdsale = Crowdsale({crowdsaleTotalSupplyLimit: _crowdsaleTotalSupplyLimit, preICOTotalSupplyLimit: preICOTotalSupplyLimit, icoTotalSupplyLimit: icoTotalSupplyLimit, teamSupplyReserved: teamSupplyReserved, platformSupplyReserved: platformSupplyReserved});
  }
